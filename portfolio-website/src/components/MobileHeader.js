    ...
    return (
        ...
        <div className={`${classes.mobileMenu} ${active ? classes.menuActive : ''} ${dark ? classes.mobileMenuDark : classes.mobileMenuLight}`}>
          ...
          <ul className={classes.menuItems}>
            ...
            <li><a className={`${classes.navBtn} ${dark ? classes.navBtnDark : classes.navBtnLight}`} href='https://drive.google.com/file/d/15A5t0aIUqD6DX9T3qB7DnZnIRcIcW3gl/view?usp=sharing' without rel="noopener noreferrer" target="_blank">Descarca CV</a></li>
          </ul>
        </div>
